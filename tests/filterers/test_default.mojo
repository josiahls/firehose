...
fn test_logger_integration() raises:
    ...
    debug_assert(messages[0] == "This is an info message", "Expected message to be 'This is an info message', got '" + messages[0] + "'")
    ...
    for level in LOG_LEVELS:
        ...
        debug_assert(len(messages) == n_expected, "Expected " + String(n_expected) + " message, got " + String(len(messages)))
        outputter[][TestLoggerOutputer].clear_messages()
